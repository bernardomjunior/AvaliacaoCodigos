...
Future<String> readInput(Stream<String> stream) {
  return stream
...
Future<CodeList> readCodes(Stream<String> stream) {
...
void run(Stream<String> stream) async {
  final sequence = await readCodes(stream);
